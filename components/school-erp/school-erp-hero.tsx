...
export default function SchoolErpHero() {
    return (
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-sm font-medium text-foreground">Enterprise-Grade School Management</span>
                    </motion.div>
                    ...
                    >
                        One Platform. Total Control. Zero Operational Guesswork.
                    </motion.p>
                    ...
                    >
                        International schools cannot afford operational disorder. OKS School ERP is an enterprise-grade platform
                        designed for schools that demand accuracy, transparency, and control.
                    </motion.p>
                    ...
                    >
                        {[
                            { icon: GraduationCap, title: "600+ Schools", desc: "Trust our platform" },
                            { icon: Shield, title: "99.9% Uptime", desc: "Enterprise reliability" },
                            { icon: TrendingUp, title: "40% Efficiency", desc: "Average improvement" },
                        ].map((item, index) => (
                            <motion.div
                                key={index}
                                initial={{ opacity: 0, y: 20 }}
