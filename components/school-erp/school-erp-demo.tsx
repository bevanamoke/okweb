                            ...
                            <div className="relative p-8 md:p-12 bg-card border border-border rounded-2xl">
                                <div className="mb-8">
                                    <h3 className="text-xl font-semibold text-foreground mb-4">
                                        Your demonstration will show:
                                    </h3>
                                    <ul className="grid md:grid-cols-2 gap-3">
                                        {[
                                            "Live fee intelligence",
                                            "Parent portal workflows",
                                            "Exam and reporting pipelines",
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            required
                                            className="w-full px-4 py-3 bg-background border border-border rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-primary transition-all"
                                            placeholder="International School of Excellence"
                                        />
                                    </div>

                                    <div>
                                        <label htmlFor="enrollment" className="block text-sm font-medium text-foreground mb-2">
                                            Current Enrollment
                                        </label>
                                        <select
                                            id="enrollment"
                        ...
                        >
                            ...
                            <div className="relative p-12 bg-card border border-primary/50 rounded-2xl text-center">
                                ...
                                <p className="text-foreground/60">
                                    Our team will contact you within 24 hours to schedule your private demonstration.
                                </p>
                            </div>
                        </motion.div>
                    )}
